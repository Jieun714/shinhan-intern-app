...
class KospiChartSmall extends StatefulWidget {
  KospiChartSmall({Key? key}) : super(key: key);

  @override
  Chart createState() => Chart();
}

class Chart extends State<KospiChartSmall> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: SfCartesianChart(
          ...
          primaryYAxis: NumericAxis(isVisible: false, visibleMinimum: 2200),
